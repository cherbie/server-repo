...
CURRENTLY:
 ---
    ...
    CHANGE THE WAY CLIENTS INIT MESSAGE IS receiveD
     - ESTABLISH CONNECTION WITH CLIENTS AND THEN PERFORM WAIT TO RECEIVE INIT FROM ALL CLIENTS ... THEN CYCLE THROUGH INITS.
     - DYNAMICALLY ALLOCATE PLAYERS* MEMORY
     - CONNECT TO ALL PLAYERS FOR A CERTAIN AMOUNT OF timeout
     - THEN WAIT FOR ALL PLAYERS TO SEND INIT (SLEEP())
     - QUICKLY CYCLE THROUGH ALL PLAYERS AND ENTER GAME