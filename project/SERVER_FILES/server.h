...
#define WAIT_TIME_MOVE 20 //MAXIMUM TIME IN SECONDS SERVERS WAITS FOR TO RECEIVE CLIENT "MOV" MESSAGE
#define WAIT_TIME_INIT 10 //MAXIMUM TIME IN SECONDS NEEDED TO WAIT FOR CLIENT TO SEND "INIT" MESSAGE
#define WAIT_TIME_CONN 20 //SECONDS NEEDED TO WAIT FOR CLIENTS TO SEND CONNECTION REQUEST
